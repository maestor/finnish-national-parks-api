import type { SykeSpecialParkSeed } from '../types.js';

export const sourceReadyReserveParkSeeds: SykeSpecialParkSeed[] = [
  {
...
export const sourceReadyDestinationAreaSeeds: SykeSpecialParkSeed[] = [
  {
    displayTypeName: null,
