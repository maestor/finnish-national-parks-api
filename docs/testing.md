...
- Published year-review shares return stable snapshot payloads instead of live derived responses and stay image-agnostic so they do not depend on expiring presigned visit-image URLs.
