...
- Manual catalog imports can add non-LIPAS-managed parks such as Paistjärvi, including custom top-level types such as `factory-village` and custom `displayTypeName` values, and later LIPAS imports do not deactivate those rows.
