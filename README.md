...
It imports curated non-LIPAS catalog rows such as Merenkurkun maailmanperintöalue, Sammallahdenmäki, Suomenlinna, Vanha Rauma, Paistjärvi, and selected ruukit / tehdaskylät, keeps their source geometry, preserves custom display labels such as `Maailmanperintökohde`, and protects those rows from later LIPAS deactivation.
